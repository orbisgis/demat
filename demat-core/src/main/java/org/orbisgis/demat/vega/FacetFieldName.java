 ...
 */
public class FacetFieldName {
    private Aggregate aggregate;
    private Double band;
    private AngleBin bin;
    private String field;
    private Header header;
    private FluffySortArray sort;
    private TimeUnitUnion timeUnit;
    private LegendText title;
    private Type type;
    private FacetFieldDefFieldName column;
    private FacetFieldDefFieldName row;
     ...
     */
    @JsonProperty("sort")
    public FluffySortArray getSort() { return sort; }
    @JsonProperty("sort")
    public void setSort(FluffySortArray value) { this.sort = value; }
     ...
     */
    @JsonProperty("column")
    public FacetFieldDefFieldName getColumn() { return column; }
    @JsonProperty("column")
    public void setColumn(FacetFieldDefFieldName value) { this.column = value; }

    /**
     * A field definition for the vertical facet of trellis plots.
     */
    @JsonProperty("row")
    public FacetFieldDefFieldName getRow() { return row; }
    @JsonProperty("row")
    public void setRow(FacetFieldDefFieldName value) { this.row = value; }
}
