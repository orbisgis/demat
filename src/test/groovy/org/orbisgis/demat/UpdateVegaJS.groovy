...
/**
 * Run this script to update the vega js libraries
...
libs.each {it->
    File output = new File("/home/ebocher/Autres/codes/new_demat/demat/src/main/resources/org/orbisgis/demat/${it.key}.js")
    output.delete()
    URL url = new URL(it.value)
