...
/**
 * This class is used to serialize a {@code ISpatialTable} as json
 *
 * @author Erwan Bocher, CNRS 2023-2024
 */
public class SpatialTableSerializer extends StdSerializer<ISpatialTable> {

    public SpatialTableSerializer() {
        this(null);
    }

    public SpatialTableSerializer(Class<ISpatialTable> t) {
        super(t);
    }

    @Override
    public void serialize(ISpatialTable spatialTable, JsonGenerator jgen, SerializerProvider serializerProvider) throws IOException {
        try {
            ...
            throw new IOException("Cannot serialize the spatial table " + spatialTable.getName(), e);
        }
    }
}
