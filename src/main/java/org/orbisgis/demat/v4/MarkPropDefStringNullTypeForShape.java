 ...
 */
public class MarkPropDefStringNullTypeForShape {
    private Aggregate aggregate;
    private Double band;
    private AngleBin bin;
    private ShapeCondition condition;
    private Field field;
    ...
    public ShapeCondition getCondition() { return condition; }
    @JsonProperty("condition")
    public void setCondition(ShapeCondition value) { this.condition = value; }
