 ...
 */
public class MarkPropDefNumber {
    private Aggregate aggregate;
    private Double band;
    private AngleBin bin;
    private StrokeDashCondition condition;
    private Field field;
    ...
    public StrokeDashCondition getCondition() { return condition; }
    @JsonProperty("condition")
    public void setCondition(StrokeDashCondition value) { this.condition = value; }
     ...
     */
    @JsonProperty("value")
    public StrokeDashUnion getValue() { return value; }
    @JsonProperty("value")
    public void setValue(StrokeDashUnion value) { this.value = value; }
}
