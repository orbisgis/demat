 ...
 */
public class FieldOrDatumDefWithConditionStringFieldDefString {
    private Aggregate aggregate;
    private Double band;
    private DescriptionBin bin;
    private FieldOrDatumDefWithConditionStringFieldDefStringCondition condition;
    private Field field;
    ...
    public FieldOrDatumDefWithConditionStringFieldDefStringCondition getCondition() { return condition; }
    @JsonProperty("condition")
    public void setCondition(FieldOrDatumDefWithConditionStringFieldDefStringCondition value) { this.condition = value; }
