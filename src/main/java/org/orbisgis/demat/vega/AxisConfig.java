...
public class AxisConfig {
    ...
    private AxisBandGridDash gridDash;
    ...
    public AxisBandGridDash getGridDash() { return gridDash; }
    @JsonProperty("gridDash")
    public void setGridDash(AxisBandGridDash value) { this.gridDash = value; }
    ...
    public AxisBandTickDash getTickDash() { return tickDash; }
    @JsonProperty("tickDash")
    public void setTickDash(AxisBandTickDash value) { this.tickDash = value; }
