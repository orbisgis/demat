...
public class MarkConfigExprOrSignalRefInterpolate {
        ...
        public MarkConfigExprOrSignalRefInterpolate deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
            ...
            switch (jsonParser.currentToken()) {
                ...
                case VALUE_STRING:
                    ...
                    try {
                        value.enumValue = Interpolate.forValue(string);
                    } catch (Exception ex) {
                        // Ignored
                    }
                    break;
    ...
    static class Serializer extends JsonSerializer<MarkConfigExprOrSignalRefInterpolate> {
        @Override
        public void serialize(MarkConfigExprOrSignalRefInterpolate obj, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
