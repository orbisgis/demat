...
public class ConditionalValueDefNumberExprRefElement {
    private ConditionalValueDefNumberExprRefPredicateComposition test;
    private ConditionalValueDefNumberExprRefValueUnion value;
     ...
     */
    @JsonProperty("value")
    public ConditionalValueDefNumberExprRefValueUnion getValue() { return value; }
    @JsonProperty("value")
    public void setValue(ConditionalValueDefNumberExprRefValueUnion value) { this.value = value; }
