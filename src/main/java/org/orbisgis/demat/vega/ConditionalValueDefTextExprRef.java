...
public class ConditionalValueDefTextExprRef {
    private ConditionalValueDefNumberExprRefPredicateComposition test;
    private ConditionalValueDefTextExprRefText value;
     ...
     */
    @JsonProperty("value")
    public ConditionalValueDefTextExprRefText getValue() { return value; }
    @JsonProperty("value")
    public void setValue(ConditionalValueDefTextExprRefText value) { this.value = value; }
