...
public class DescriptionClass {
    ...
    private DescriptionCondition condition;
    private Field field;
    ...
    public DescriptionCondition getCondition() { return condition; }
    @JsonProperty("condition")
    public void setCondition(DescriptionCondition value) { this.condition = value; }
