...
public class ConditionalValueDefNumberExprRef {
    private ConditionalValueDefNumberExprRefPredicateComposition test;
    private ConditionalValueDefNumberExprRefValue value;
     ...
     */
    @JsonProperty("value")
    public ConditionalValueDefNumberExprRefValue getValue() { return value; }
    @JsonProperty("value")
    public void setValue(ConditionalValueDefNumberExprRefValue value) { this.value = value; }
