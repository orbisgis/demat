...
public class Scale {
     ...
     */
    @JsonProperty("align")
    public CornerRadius getAlign() {
        return align;
    }

    @JsonProperty("align")
    public void setAlign(CornerRadius value) {
        this.align = value;
    }
     ...
     */
    @JsonProperty("base")
    public CornerRadius getBase() {
        return base;
    }

    @JsonProperty("base")
    public void setBase(CornerRadius value) {
        this.base = value;
    }
     ...
     */
    @JsonProperty("bins")
    public ScaleBins getBins() {
        return bins;
    }

    @JsonProperty("bins")
    public void setBins(ScaleBins value) {
        this.bins = value;
    }
     ...
     */
    @JsonProperty("clamp")
    public Aria getClamp() {
        return clamp;
    }

    @JsonProperty("clamp")
    public void setClamp(Aria value) {
        this.clamp = value;
    }
    ...
    public CornerRadius getConstant() {
        return constant;
    }

    @JsonProperty("constant")
    public void setConstant(CornerRadius value) {
        this.constant = value;
    }
    ...
    public DomainM getDomainMax() {
        return domainMax;
    }

    @JsonProperty("domainMax")
    public void setDomainMax(DomainM value) {
    ...
    public CornerRadius getDomainMid() {
        return domainMid;
    }

    @JsonProperty("domainMid")
    public void setDomainMid(CornerRadius value) {
        this.domainMid = value;
    }
    ...
    public DomainM getDomainMin() {
        return domainMin;
    }

    @JsonProperty("domainMin")
    public void setDomainMin(DomainM value) {
    ...
    public CornerRadius getExponent() {
        return exponent;
    }

    @JsonProperty("exponent")
    public void setExponent(CornerRadius value) {
        this.exponent = value;
    }
    ...
    public ScaleInterpolate getInterpolate() {
        return interpolate;
    }

    @JsonProperty("interpolate")
    public void setInterpolate(ScaleInterpolate value) {
    ...
    @JsonProperty("nice")
    public void setNice(Nice value) {
        this.nice = value;
    }
    ...
    public CornerRadius getPadding() {
        return padding;
    }

    @JsonProperty("padding")
    public void setPadding(CornerRadius value) {
        this.padding = value;
    }
    ...
    public CornerRadius getPaddingInner() {
        return paddingInner;
    }

    @JsonProperty("paddingInner")
    public void setPaddingInner(CornerRadius value) {
    ...
    public CornerRadius getPaddingOuter() {
        return paddingOuter;
    }

    @JsonProperty("paddingOuter")
    public void setPaddingOuter(CornerRadius value) {
     ...
     */
    @JsonProperty("range")
    public ScaleRange getRange() {
        return range;
    }

    @JsonProperty("range")
    public void setRange(ScaleRange value) {
        this.range = value;
    }
    ...
    public Coordinate getRangeMax() {
        return rangeMax;
    }

    @JsonProperty("rangeMax")
    public void setRangeMax(Coordinate value) {
        this.rangeMax = value;
    }
    ...
    public Coordinate getRangeMin() {
        return rangeMin;
    }

    @JsonProperty("rangeMin")
    public void setRangeMin(Coordinate value) {
        this.rangeMin = value;
    }
    ...
    public Aria getReverse() {
        return reverse;
    }

    @JsonProperty("reverse")
    public void setReverse(Aria value) {
        this.reverse = value;
    }
     ...
     */
    @JsonProperty("round")
    public Aria getRound() {
        return round;
    }

    @JsonProperty("round")
    public void setRound(Aria value) {
        this.round = value;
    }
    ...
    /**
     * Set a the scale type to square
     *
     * @return
     */
    public Scale sqrt() {
        this.setType(ScaleType.SQRT);
        return this;
    }
    ...
    public Scale rangeMin(double value) {
        Coordinate coordinate = new Coordinate();
        coordinate.doubleValue = value;
        this.setRangeMin(coordinate);
        return this;
    }

    public Scale rangeMax(double value) {
        Coordinate coordinate = new Coordinate();
        coordinate.doubleValue = value;
        this.setRangeMax(coordinate);
        return this;
    }
